/* Creating the Database and The required Layers (Schema) */
...
/* Creating the Bronze layer TABLES as it is in raw csv file*/
...
/* First Empty the table and then we can BULK Insert the raw data as it is in the Brone layer Tables*/
