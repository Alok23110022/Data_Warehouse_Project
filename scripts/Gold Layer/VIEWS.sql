/* Here are the Main VIEWS for the dim_customer, dim_products as the dimension tables and fact_sales for the Fact table*/
-- FOR THE gold.dim_customers
