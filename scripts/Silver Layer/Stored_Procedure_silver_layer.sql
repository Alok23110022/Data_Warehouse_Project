/* This file contains all the queries which are being executed for the transformation and Inserting Purposes from Raw Bronze Layer To Cleaned Silver Layer */
...
-----------------------------------------------------------------------------------------------------------------------------
	...
	PRINT '=========================================================';
		...
		SET @start_time = GETDATE();
			...
			FROM Bronze.crm_cust_info) AS t WHERE Flag_duplicates = 1 AND cst_id IS NOT NULL;
